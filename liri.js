...
//--------------------------------------------------- //
let choiceArray = [
	"tweets=> search twitter for users/topics",
	"spotify-this-song=> search spotify for songs",
	"movie-this=> search imdb for movie information",
	"do-what-it-says=> run a random command/search",
	"add-command=> add a command/search to the do-what-it-says list"
]
// Run the program
const runProg = () => {
	inquirer.prompt([{
